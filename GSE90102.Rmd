...
We note that BH, qvalue and swfdr procedures reject the same variants : reduction of the number of procedure.

We notice that the BH, qvalue and swfdr procedures reject the same variants $\Rightarrow$ reduction of the number of procedures. Moreover, we note that the FDRreg procedure rejects a similar number of markers as the BH, qvalue and swfdr procedures. 
