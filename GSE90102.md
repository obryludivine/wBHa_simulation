...
The p-values (GSE90102\_01$rawp) and Minor Allele Frequencies
(GSE90102\_01$MAF) of the SNPs from this association test are available
in the wBHa package (GSE90102\_01).
...
<img src="GSE90102_files/figure-gfm/Histogram_rejects-1.png" style="display: block; margin: auto;" />
...
<img src="GSE90102_files/figure-gfm/UpsetR-1.png" style="display: block; margin: auto;" />

We note that BH, qvalue and swfdr procedures reject the same variants :
reduction of the number of procedure. We also notice that the BH, qvalue
and swfdr procedures reject the same variants ⇒ reduction of the number
of procedures. Moreover, we note that the FDRreg procedure rejects a
similar number of markers as the BH, qvalue and swfdr procedures.
...
<img src="GSE90102_files/figure-gfm/Histogram_subgoups-1.png" style="display: block; margin: auto;" />
We can note that wBHa focuses on rare markers (less than 5%). However,
although this is also the case for the other weighted procedures
combining the two types of approaches, these are less powerful for rare
variants than wBHa.
...
<img src="GSE90102_files/figure-gfm/Venn-1.png" style="display: block; margin: auto;" />
This diagram shows that a large number of the rejected SNPs by the wBHa
procedure are specific to it.
